  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="starter-template">
        <h1>Selecione a função do novo usuário.</h1>
          <form action="cadastroDados.php" method="post">
            <input type="radio" name="func" value="vendedor"> Vendedor<br>
            <input type="radio" name="func" value="fornecedor" checked> Fornecedor<br>
            <input type="submit" name='button' value="Próximo"></input>
          </form>
