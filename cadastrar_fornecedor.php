...
$_SESSION['cadastrado'] = "fornecedor";
?>
<!DOCTYPE html>
<html lang="en">
						...
						<div class="col-md-12 portfolio-item">
                            ...
                            ?>
                                <div class="row">	<div class="col-md-6"><label for="nomeEmpresa" class="licitacao_item_title">Razão Social:</label></div>
                                                    <div class="col-md-6"><input type="text" class="form-control" rows="4" id="nomeEmpresa" name="nomeEmpresa" required></div>				</div><hr>
								...
								<div class="row">	<div class="col-md-6"><label for="CNPJ" class="licitacao_item_title">CNPJ:</label></div>
													<div class="col-md-6"><input type="text" class="form-control" rows="4" id="CNPJ" name="CNPJ" required></div>				</div><hr>
								...
								<div class="row">	<div class="col-md-6"><label for="nomeResponsavel" class="licitacao_item_title">Responsável:</label></div>
													<div class="col-md-6"><input type="text" class="form-control" rows="4" id="nomeResponsavel" name="nomeResponsavel" required></div>				</div><hr>
								<div class="row">	<div class="col-md-6"><label for="endereco" class="licitacao_item_title">Endereço:</label></div>
													<div class="col-md-6"><input type="text" class="form-control" rows="4" id="endereco" name="endereco" required></div>				</div><hr>
