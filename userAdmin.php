...
<div class="container">
  ...
  <form role="form" action="editar.php" method="post">
    <div class="row">
      <div class="col-lg-12">
        <h1 class="page-header">Alterar Informações da conta de <?php echo $todos->getNome();?> <span class="licitacao_item_icone glyphicon glyphicon-pencil"></span> </h1><br /><br />
        ...
        <div class="row">
          <div class="col-md-12 portfolio-item"><?php
            ...
            <div class="row">	<div class="col-md-6"><label for="nome" class="licitacao_item_title">Nome:</label></div>
              <div class="col-md-6"><input type="text" class="form-control" rows="4" id="nome" name="nome" value="<?php echo $todos->getNome();?>"  required></div>				</div><hr>
